...
| **Carnets de mesures** | des constats datés, avec leur méthode — **pas** des engagements. **Ils sont en ANNEXE**, à la fin du document | `Pourquoi ce plugin existe` · `Le transport est DÉJÀ compressé` · `Deux noms de journal — et 39 sessions qui n'existaient pas` · `« Le service est absent de la composition »` · `Une erreur avalée a coûté une heure de diagnostic` · `Le piège : dans un waterfall…` · `Ce qui a été mesuré, et qui a coûté du temps` · `Ce qui est gardé en mémoire, et POURQUOI DU TEXTE` · `Ce qui a été prouvé, et comment` |
...
autorité sur le comportement. Ces sections ont été DÉPLACÉES en annexe, et leur place
...
> **Carnet de mesures** — « Deux noms de journal » est en annexe, à la fin de ce document.

> **Carnet de mesures** — « « Le service est absent » est en annexe, à la fin de ce document.

> **Carnet de mesures** — « Une erreur avalée » est en annexe, à la fin de ce document.
...
> **Carnet de mesures** — « Le piège : dans un waterfall » est en annexe, à la fin de ce document.
...
> **Carnet de mesures** — « Ce qui a été mesuré, et qui a coûté du temps » est en annexe, à la fin de ce document.
...
> **Carnet de mesures** — « Ce qui est gardé en mémoire » est en annexe, à la fin de ce document.
...
> **Carnet de mesures** — « Ce qui a été prouvé, et comment » est en annexe, à la fin de ce document.
...
**CE QUE CETTE ANNEXE CONTIENT, ET CE QU'ELLE N'EST PAS.** Ces sections racontent
comment une règle est née : un défaut observé, la mesure qui l'a établi, et le remède.
Elles sont ce qui permet de MODIFIER une règle sans la casser — et elles n'ont **aucune
autorité** sur le comportement. Le contrat, la procédure et les limites ouvertes sont
au-dessus, dans l'index. En cas de doute, c'est le contrat qui tranche : si le code dit
autre chose, c'est un défaut, pas une interprétation.

**POURQUOI ELLES SONT ICI, ET PAS SUPPRIMÉES.** Un dépôt dont la documentation oublie
POURQUOI une règle existe finit par la voir « simplifiée » par quelqu'un de bonne foi —
et le défaut revient. La valeur de ces récits est réelle ; leur place est simplement
après le contrat, pas dedans.
